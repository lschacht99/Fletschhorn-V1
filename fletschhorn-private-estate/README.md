...
- Translations: add translated strings to `src/data/page-content.json` and wire them through `src/js/fletschhorn-i18n.js`.
...
The CSS enforces a sharp, architectural, clay-white/mineral-white luxury system: no rounded corners, no pill buttons, thin lines, rectangular image panels, editorial typography, atmospheric overlays, scroll reveals, floating fact cards and reduced-motion support.
